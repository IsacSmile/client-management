                  ...
                  <div className="flex items-center justify-between gap-2.5">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <Link href={`/clients/${r.clientId}`} className="font-semibold text-zinc-900 hover:underline text-xs sm:text-sm truncate block">
                          {r.clientName}
                        </Link>
                        <p className="text-[11px] text-zinc-400 font-normal truncate mt-0.5">{r.projectName}</p>
                      </div>
                    </div>
